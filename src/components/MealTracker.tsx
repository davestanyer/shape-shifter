...
export function MealTracker({ onMealAdded, selectedDate, onDateSelect }: MealTrackerProps) {
  ...
  const handleLogMeal = async (data: any) => {
    ...
    const mealData = {
      ...
      date: data.date,
      created_at: new Date().toLocaleString('en-US', { timeZone: 'Pacific/Auckland' })
    };
  ...
  const isToday = selectedDate === new Date(new Date().toLocaleString('en-US', { timeZone: 'Pacific/Auckland' }))
    .toISOString()
    .split('T')[0];
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              max={new Date(new Date().toLocaleString('en-US', { timeZone: 'Pacific/Auckland' }))
                .toISOString()
                .split('T')[0]}
